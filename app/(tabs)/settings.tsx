    ...
    <ScreenContainer>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: hp, paddingTop: 8, paddingBottom: 100 }}>
        ...
        {biometricAvailable && Platform.OS !== "web" && (
          <View style={[styles.card, { backgroundColor: colors.surface, borderColor: colors.border }]}>
            <Text style={[styles.cardLabel, { color: colors.muted }]}>Security</Text>
            <View style={styles.switchRow}>
              <View style={styles.switchLabel}>
                <IconSymbol name={biometricType === "face" ? "faceid" as any : "touchid" as any} size={20} color={colors.primary} />
                <View style={{ marginLeft: 12, flex: 1 }}>
                  <Text style={{ fontSize: 15, fontWeight: "500", color: colors.foreground }}>
                    {biometricType === "face" ? "Face ID Lock" : "Fingerprint Lock"}
                  </Text>
                  <Text style={{ fontSize: 12, color: colors.muted, marginTop: 2 }}>
...
const styles = StyleSheet.create({
  ...
  durationRow: { flexDirection: "row", flexWrap: "wrap", gap: 8, width: "100%" },
  durationChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10, borderWidth: 1, alignItems: "center", justifyContent: "center", minHeight: 36 },
  switchRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  switchLabel: { flexDirection: "row", alignItems: "center", flex: 1 },
  dayRow: { flexDirection: "row", alignItems: "center", paddingVertical: 10, width: "100%" },
  ...
  schedTabRow: { flexDirection: "row", gap: 8, marginBottom: 14, width: "100%" },
