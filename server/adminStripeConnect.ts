...
<body>
  <div class="sidebar">
    <div class="sidebar-logo" style="display:flex;align-items:center;gap:10px;"><img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663347678319/IvzpqiWWzFzYmkTo.png" alt="Lime Of Time" style="width:32px;height:32px;border-radius:8px;object-fit:cover;" /><span>Admin</span></div>
